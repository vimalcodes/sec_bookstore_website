      ...
      <!-- brands to be displayed -->
        <ul class="navbar-nav me-auto text-center">
          <li class="nav-item bg-info">
            <a href="#" class="nav-link text-light"><h4>Promotion</h4></a>
          </li>

<?php

// calling function to get brands in sidenav
getbrands()
...
// calling function to get categories in sidenav
getcategories()
